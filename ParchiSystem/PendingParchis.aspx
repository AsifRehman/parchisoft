<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PendingParchis.aspx.cs" Inherits="ParchiSystem.PendingParchis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%;">
        <tr>
            <td style="text-align: center; padding-bottom: 5px">From:
